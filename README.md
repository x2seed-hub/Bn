...
Page10.CreateToggle({
	...
	Dis = "Tự động làm nhiệm vụ tộc v4",
	Value = false,
	Callback = function(v)
	_G.AutoRace = v
	StardFarm = v
...
Page10.CreateDropdown({
	Name = "Teleport Race Door",
	Value = "1",
	List = RaceDoor,
	Callback = function(v)
	Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
...
Page10.CreateToggle({
	...
	Dis = "Kill người chơi trong Trail",
	Value = false,
	Callback = function(v)
	_G.AutoKillTial = v
...
Page11.CreateToggle({
	Name = "Super Raid",
	Dis = "1 Click tự raid hết tất cả",
	Value = false,
	Callback = function(v)
    	_G.Auto_StartRaid = v
        _G.Kill_Aura = v
...
Page11.CreateToggle({
	Name = "Auto Awaken",
	Dis = "Tự động thức tỉnh khi xong raid",
	Value = false,
	Callback = function(v)
    	_G.Awaken = v
		print(v)
...
Page13.CreateButton({
	Name = " Buy Cyborg Race [ Use ฦ’2,500 ]",
	Callback = function()
...
Page14.CreateDropdown({
	...
	Value = "Thông thường - Huyền thoại",
...
Page14.CreateToggle({
	...
	Dis = "Thêm thông báo khi trái cây đẻ trứng",
	Value = false,
	Callback = function(v)
	_G.FruitCheck = v
		print(v)
...
Page14.CreateToggle({
	Name = "Tween To Fruit",
	Dis = "Dịch chuyển đến trái khi spam",
	Value = false,
	Callback = function(v)
	_G.Tweenfruit = v
